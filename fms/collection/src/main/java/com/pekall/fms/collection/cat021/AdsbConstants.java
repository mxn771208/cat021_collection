...
public class AdsbConstants {
  ...
  //1节转换为米/秒
  public static final double kNot2Second = 1852.00/3600;
  //1英尺转换为米
  public static final double kFt2Metre = 0.3048;
  ...
  public static final short DI_HIGH_RESOLUTION_POSITION_IN_WGS84 = 131;
  ...
  //Geometric Altitude
  public static final short DI_GEOMETRIC_Height = 140;
  //Quality Indicators
